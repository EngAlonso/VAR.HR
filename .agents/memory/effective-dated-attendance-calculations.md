...
**How to apply:** Persist applied rule metadata with each calculation and make payroll consume stored calculations rather than re-evaluating old attendance against today’s rules.