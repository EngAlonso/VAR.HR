...
export const STANDARD_PERMISSIONS = [
  ...
  ["schedules", "Schedules (legacy)", "Legacy schedule capability; use view/manage schedule permissions."],
  ["holidays", "Holidays (legacy)", "Legacy holiday capability; use view/manage holiday permissions."],
  ...
  ["devices", "Biometric devices (legacy)", "Legacy device capability; use view/manage device permissions."],
  ["sync-history", "Sync history (legacy)", "Legacy sync capability; use the view sync history permission."],
  ["organization.manage", "Organization", "Manage departments and branches."],
  ["dashboard.view", "Dashboard", "View the company dashboard."],
  ["employees.create", "Create employees", "Create employee records."],
  ["employees.edit", "Edit employees", "Edit employee records."],
  ["employees.archive", "Archive employees", "Archive employee records."],
  ["departments.view", "View departments", "View departments and their records."],
  ["departments.manage", "Manage departments", "Create, edit, and archive departments."],
  ["branches.view", "View branches", "View branches and their records."],
  ["branches.manage", "Manage branches", "Create, edit, and archive branches."],
  ["attendance.rules.view", "View attendance rules", "View attendance rules and rule history."],
  ["attendance.rules.manage", "Manage attendance rules", "Create and update attendance rules."],
  ["schedules.view", "View schedules", "View shift organization and assignments."],
  ["schedules.manage", "Manage schedules", "Create and update schedules and assignments."],
  ["holidays.view", "View holidays", "View company holidays."],
  ["holidays.manage", "Manage holidays", "Create, edit, and remove company holidays."],
  ["leave.view", "View leave", "View leave requests and balances."],
  ["leave.manage", "Manage leave settings", "Manage leave policies and settings."],
  ["payroll.manage", "Manage payroll", "Calculate and manage payroll records."],
  ["devices.view", "View devices", "View biometric devices and status."],
  ["devices.manage", "Manage devices", "Manage biometric devices and mappings."],
  ["sync-history.view", "View sync history", "View biometric synchronization history."],
  ["locations.view", "View locations", "View GPS attendance locations."],
  ["locations.manage", "Manage locations", "Create and update GPS attendance locations."],
  ["backups.view", "View backups", "View backup records."],
  ["backups.manage", "Manage backups", "Create and restore backups."],
  ["company.settings", "Company settings", "Manage company settings."],
  ["audit.view", "View audit history", "View audit and account history."],
] as const;
