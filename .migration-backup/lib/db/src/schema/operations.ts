...
export const attendanceCalculationsTable = pgTable("var_hr_attendance_calculations", {
  ...
  appliedOvertimeMultiplier: numeric("applied_overtime_multiplier", { precision: 6, scale: 3, mode: "number" }).notNull().default(1),
  multiplierSource: text("multiplier_source").notNull().default("standard"),
  timeMultiplierPremiumMinutes: numeric("time_multiplier_premium_minutes", { precision: 10, scale: 3, mode: "number" }).notNull().default(0),
...
export const attendanceRulesTable = pgTable("var_hr_attendance_rules", {
  ...
  timeMultipliers: jsonb("time_multipliers").notNull().default([]),
