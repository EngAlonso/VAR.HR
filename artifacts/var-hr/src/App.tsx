...
function BackupRestore() {
  ...
  const [uploadedBackup, setUploadedBackup] =
  ...
  const labels = isArabic
    ? {
        ...
        company: "نسخة الشركة",
        safety: "نسخة أمان",
        downloadSection: "النسخ الاحتياطية المحفوظة",
    ...
    : {
        ...
        downloadSection: "Downloaded backups",
        restoreSection: "Restore from device",
        generatedDetail: "Backups generated by VAR HR and available to download.",
        restoreDetail:
